...
@section('title', 'Reactive Work Instrument')
            ...
            <div class="row">
                <div class="col-lg-12 mb-4 order-0">
                    <div class="card">
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-7">
                                <div class="card-body">
                                    <h5 class="card-title text-primary">KPI Work Reactive {{ $namaunit }} 📖</h5>
                                    <p class="mb-4">
                            ...
                            <div class="col-6 mt-2 col-sm-12 align-self-center">
                                ...
                                @if ($option == 'TINST')
                                    <button class="btn btn-danger "
                                        onclick="window.open('{{ asset('/pmcompliancepdftinst12/print_report') }}','_blank')"
                                ...
                                @if ($option == 'TINST34')
                                    <button class="btn btn-danger "
                                    onclick="window.open('{{ asset('/pmcompliancepdftinst34/print_report') }}','_blank')"
                                        type="button" target="_blank">
                    ...
                    <div class="card h-100">
                        <div class="card-header d-flex align-items-center justify-content-between pb-0">
                            <div class="card-title mb-0">
                                <h5 class="m-0 me-2">Work Reactive {{ $namaunit }}</h5>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex flex-column align-items-start gap-1">
                                    <h4 class="mt-3">Non Tactical : {{ $totalwonontactical }} </h4>
                                    <h4 class="mb-2">Tactical : {{ $totalwotactical }}</h4>
                                </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-8 order-0 mb-4">
                    <div class="card h-50">
                        <div class="card-header d-flex align-items-center justify-content-between pb-0">
                            <div class="card-title mb-0">
                                <h5 class="m-0 me-2">Grafik Reactive Work {{ $namaunit }}</h5>
                                <small class="text-muted">Periode Januari - Desember {{ $thisyear }}</small>
                            </div>
                            <div class="dropdown">
                                <button class="btn p-0" type="button" id="orederStatistics" data-bs-toggle="dropdown"
