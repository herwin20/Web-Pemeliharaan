...
@section('title', 'Wrench Time Instrument')
                ...
                <div class="col-lg-12 mb-4 order-0">
                    <div class="card">
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-7">
                                <div class="card-body">
                                    <h5 class="card-title text-primary">KPI Wrench Time {{ $namaunit }} 📖</h5>
                                    <p class="mb-4">
                    ...
                    <div class="card mt-2 mb-3">
                        ...
                        <div class="card-body">
                            <form action="{{ route('kpi/wrenchtimeinst.import') }}" method="POST"
