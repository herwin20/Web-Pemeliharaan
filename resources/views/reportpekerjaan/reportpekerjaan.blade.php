            ...
            <div class="row px-3">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="text-center bold">LIST PEKERJAAN HARIAN 1-2</h2>
                        <div class="text-start mb-3">
                            <button type="button" name="create_record" id="create_record" data-bs-target="#formModal"
                                class="btn rounded-pill btn-primary">
                                <span class="tf-icons bx bx-plus"></span> Add</button>
                            <button onclick="location.href='report-analyze'" type="button" id="analyzereport"
                                data-bs-target="#formModal" class="btn rounded-pill btn-danger">
                                <span class="tf-icons bx bx-chart"></span> Analyze</button>
                        </div>
                        <div class="table-responsive text-nowrap">
                            <table class="table table-striped report_datatable">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Week</th>
