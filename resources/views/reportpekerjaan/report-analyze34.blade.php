            ...
            <div class="col-lg-8 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">Analyze Report Pekerjaan Harian Blok 3-4 🎉</h5>
                                <p class="mb-4">
                                ...
                                <a href="/report-pekerjaan" class="btn btn-sm btn-outline-primary">Table Report</a>
                            </div>
                        </div>
