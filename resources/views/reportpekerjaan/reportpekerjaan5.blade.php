...
@section('content')
    ...
    <div class="content-wrapper">
            ...
            <div class="row px-3">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="text-center bold">LIST PEKERJAAN HARIAN BLOK 5</h2>
                        <div class="text-start mb-3">
                            <button type="button" name="create_record5" id="create_record5" data-bs-target="#formModal"
                                class="btn rounded-pill btn-primary">
                                <span class="tf-icons bx bx-plus"></span> Add</button>
                            <button onclick="location.href='report-analyze5'" type="button" id="analyzereport"
                                data-bs-target="#formModal" class="btn rounded-pill btn-danger">
                                <span class="tf-icons bx bx-chart"></span> Analyze</button>
                        </div>
                        <div class="table-responsive text-nowrap">
                            <table class="table table-striped report_datatable5">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Week</th>
        ...
        <div class="modal fade" id="confirmModal5" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true"
        ...
        <div class="modal fade" id="formModal5" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true"
            data-bs-keyboard="false" data-bs-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" id="history_form5" class="form-horizontal">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <input type="submit" name="action_button5" id="action_button5" value="Add Blok 5"
