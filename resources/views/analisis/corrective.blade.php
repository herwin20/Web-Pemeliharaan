...
@section('content')
            ...
            <div class="container">
                <div class="row justify-content-evenly">
                    ...
                    <div class="card col-lg-5 col-md-12">
                        <h5 class="card-header">Corrective Maintenance Sering Terjadi</h5>
                        <div class="table-responsive text-nowrap">
                            <table class="table table-striped">
                                ...
                                <tbody class="table-border-bottom-0">
                                    @foreach ($tablecorrectivefreq as $item)
                                        <tr>
                                            <td>{{ $item->equip_no }}</td>
                                            <td>{{ $item->wo_desc }}</td>
                                            <td>{{ $item->total }}</td>
                    ...
                    <!-- Striped Rows -->
                    <div class="card col-lg-5 col-md-12">
                        <h5 class="card-header">Corrective Maintenance Sering Terjadi {{ $thisyear }}</h5>
                        <div class="table-responsive text-nowrap">
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                ...
                                <tbody class="table-border-bottom-0">
                                    @foreach ($tablecorrectiveyear as $item)
                                        <tr>
                                            <td>{{ $item->equip_no }}</td>
                                            <td>{{ $item->wo_desc }}</td>
                                            <td>{{ $item->total }}</td>
                        ...
                        <div class="row justify-content-evenly">
                            <div class="col-6 col-sm-6 align-self-center">
                                ...
                                <div class="row text-center">
                                    <small>Copy KKS untuk melihat apa saja Correctivenya</small>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="card col-lg-6 col-md-12 mb-3">
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table table-striped">
                                ...
                                <tbody class="table-border-bottom-0">
                                    @foreach ($tablecorrectivedetail as $item)
                                        <tr>
                                            <td>{{ $item->equip_no }}</td>
                                            <td>{{ $item->wo_desc }}</td>
                        ...
                        <div class="card h-100">
                            <div class="card-header d-flex align-items-center justify-content-between pb-0">
                                <div class="card-title mb-0">
                                    <h5 class="m-0 me-2">Grafik Total WO CR Pertahun</h5>
    ...
    <script>
        const ctx = document.getElementById('trackingCorr');
        const total = @json($totalcorr);
