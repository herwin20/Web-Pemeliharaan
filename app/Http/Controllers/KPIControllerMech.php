...
class KPIControllerMech extends Controller
{
    //
    ...
    public function import()
    {
        ...
        return redirect('wrenchtimemech')->with('success', 'File has been added succesfully!');
    }
}
